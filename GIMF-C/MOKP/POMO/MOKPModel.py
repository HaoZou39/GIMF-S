...
class KPModel(nn.Module):
    ...
    def pre_forward(self, reset_state, pref):
        ...
        self.encoded_nodes_q = self.encoder(reset_state.problems, pref, reset_state.item_weight_img)
        
        self.encoded_graph = self.encoded_nodes_q[:, :problem_size].mean(dim=1, keepdim=True)
        ...
        self.encoded_nodes_kv = self.encoded_nodes_q.clone()
...
class KP_Encoder(nn.Module):
    ...
    def forward(self, data, pref, img):
